...
const AboutCollege = () => {
    return (
        ...
        <div className="about-college-container">
            <h2 className='heading'>A Societal Mission</h2>
            <section className='container'>
                <p id='paratext'>To provide high quality technical education through a creative balance of academic and industry oriented learning; to create an inspiring environment of scholarship and research; to instill high levels of academic and professional discipline; and to establish standards that inculcate ethical and moral values that contribute to growth in career and development of society in general.</p>
            </section>
            
        <h2 className='heading'>A Societal Vision</h2>
        <section className='container'>
            <p id='paratext'>To emerge as a premier institution in the field of technical education and research in the state and as a home for holistic development of the students and contribute to the advancement of society and the region.</p>
        </section>
       <br></br>
